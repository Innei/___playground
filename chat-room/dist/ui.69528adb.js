...
},{"preact":"node_modules/preact/dist/preact.module.js"}],"node_modules/parseuri/index.js":[function(require,module,exports) {
/**
 * Parses an URI
 *
...
},{"./common":"node_modules/debug/src/common.js","process":"../../../.config/yarn/global/node_modules/process/browser.js"}],"node_modules/socket.io-client/lib/url.js":[function(require,module,exports) {
...
},{"./polling":"node_modules/engine.io-client/lib/transports/polling.js","component-inherit":"node_modules/component-inherit/index.js","../globalThis":"node_modules/engine.io-client/lib/globalThis.browser.js"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/_empty.js":[function(require,module,exports) {
...
},{"./url":"node_modules/socket.io-client/lib/url.js","socket.io-parser":"node_modules/socket.io-parser/index.js","./manager":"node_modules/socket.io-client/lib/manager.js","debug":"node_modules/debug/src/browser.js","./socket":"node_modules/socket.io-client/lib/socket.js"}],"observable.js":[function(require,module,exports) {
"use strict";
/*
 * @Author: Innei
 ...
 */
// @ts-check
var client = (0, _socket.default)('http://127.0.0.1:2333/web');
...
client.on('message', function (_ref) {
  ...
  switch (type) {
    case 'DANMAKU_CREATE':
      {
        _observable.default.emit('e', data);
      }
  }
});
},{"socket.io-client":"node_modules/socket.io-client/lib/index.js","./observable":"observable.js"}],"ui.js":[function(require,module,exports) {
"use strict";
...
function App() {
  var _useState = (0, _hooks.useState)([]),
      ...
      danmaku = _useState2[0],
      setDanmaku = _useState2[1];
  ...
  var _useState5 = (0, _hooks.useState)(new Date()),
      _useState6 = _slicedToArray(_useState5, 1),
      startTime = _useState6[0];

  var handlePost = function handlePost(e) {
    // client.emit('DANMAKU_CREATE', value, (data) => console.log(data))
    _index.client.emit('DANMAKU_CREATE', {
      content: value,
      path: '/',
      duringTime: 5,
      startTime: Math.floor((new Date().getTime() - startTime.getTime()) / 1000)
    });
  };

  _observable.default.on('e', function (data) {
    setDanmaku(data);
  });

  return (0, _preact.h)("div", null, (0, _preact.h)("ul", null, danmaku.map(function (d) {
    return (0, _preact.h)("li", null, "content: ", d.content, " time at: ", d.startTime);
  })), (0, _preact.h)("input", {
    type: "text",
    value: value,
  ...
  }), (0, _preact.h)("span", null, value), (0, _preact.h)("button", {
    onClick: handlePost
  }, "\u53D1\u9001"));
}

(0, _preact.render)((0, _preact.h)(App, null), document.body);
},{"preact":"node_modules/preact/dist/preact.module.js","preact/hooks":"node_modules/preact/hooks/dist/hooks.module.js","./index":"index.js","./observable":"observable.js"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","ui.js"], null)
